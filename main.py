...
try:
    from modules.PlayerInformationPage import PlayerInfoPage
    from modules.FinancialManagementPage import FinancialPage
    from modules.MatchPointManagementPage import MatchPointPage
