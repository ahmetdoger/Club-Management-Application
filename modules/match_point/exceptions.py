...
# MODULE 3 - CUSTOM EXCEPTION CLASSES   Bu modül, Futbol Yönetim Sistemi'nde oluşabilecek özel hataları yönetir.Sistemin genel hata sınıfı. Diğer tüm hatalar bu sınıftan türetilir.
