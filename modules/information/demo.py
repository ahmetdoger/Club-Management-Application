...
def run_demo_scenario():
    print("================================================================")
    print("      SPOR KULÜBÜ YÖNETİM SİSTEMİ - DEMO")
    print("================================================================\n")
    ...
    pro_athlete = ProfessionalAthlete(
        athlete_id=101, name="Victor", surname="Osimhen", age=26, gender="Male",
        height=187, weight=75, sport_branch="Football", status="Active",
    ...
    amateur_athlete = AmateurAthlete(
        athlete_id=102, name="İlkin", surname="Aydın", age=25, gender="Female",
    ...
    youth_athlete = YouthAthlete(
        athlete_id=103, name="Alperen", surname="Şengün", age=14, gender="Male",
    ...
    for athlete in roster:
        ...
        print(f"   {athlete.name:<20} |{athlete.surname:<20}| {role:<20} |{athlete.branch_strong_side():<25}|{cost:,.2f}TL")
    print("-" * 110 + "\n")
